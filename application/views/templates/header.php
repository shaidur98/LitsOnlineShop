    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo site_url(); ?>">Computer Shop</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-flag-o fa-fw"></i> Brand Setup <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo site_url('admin/brands?a=add'); ?>">Add Brand</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('admin/brands'); ?>">Brand List</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo site_url('admin/products?a=add'); ?>">Add Product</a>
                                </li>
                                <li>
