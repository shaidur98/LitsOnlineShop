                                    ...
                                    <?php $counter = 0; foreach($products as $row) { $counter++;?>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                                    ...
                                                    <a href="<?php echo site_url('admin/products?a=view&id='.$row->product_code); ?>" class="btn btn-info" data-toggle="tooltip" data-placement="top" title="View">

                                                        <i class="fa fa-eye fa-fw"></i>

                                                    </a>                                            

                                                    <a href="<?php echo site_url('admin/products?a=edit&id='.$row->product_code); ?>" class="btn btn-success" data-toggle="tooltip" data-placement="top" title="Edit">

                                                        <i class="fa fa-edit fa-fw"></i>

                                                    </a>

                                                    <a onclick="return confirm('Are you sure you want to delete this product?')" href="<?php echo site_url('admin/products?a=delete&id='.$row->product_code); ?>" class="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Delete">
