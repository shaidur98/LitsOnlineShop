								...
								<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
									...
									<div class="single-product-item">
										...
										<div class="product-image">
											...
											<a href="<?php echo site_url('cs/single_product?id='.$row->product_code);?>" title=""><img src="<?php echo base_url().'uploads/product_img/'.$row->product_img; ?>" /></a>
										...
										<div class="single-product-text">
											...
											<h2><a class="product-title" href="<?php echo site_url('cs/single_product?id='.$row->product_code);?>" title=""><?php echo $row->name;?></a></h2>
											...
											<div class="pro-add-to-cart">
												...
												<p><a href="<?php echo site_url('cs/single_product?id='.$row->product_code);?>" title="view_details">View Details</a></p>
