<?php 
    ...
    class Crud extends CI_Model {
        ...
        function delete_product($table, $id) {
            ...
            $is_exist = $this->db->get_where($table, array('product_code'=>$id))->num_rows();
            ...
            if($is_exist > 0) {
                ...
                if(!$this->db->delete($table)) {
                    ...
                    die('Something error in deleting Product!');

                }

                $this->session->set_flashdata('msg','Product has been deleted successfully!');
        ...
        function update_product($table, $id, $data) {
        ...
        function get_product_by_id($table, $field, $id) {

            $result = $this->db->get_where($table, array('product_code'=>$id));
