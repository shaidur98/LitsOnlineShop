...
<!-- Mirrored from devitems.com/tf/greentech-preview/GreenTech/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Dec 2015 17:15:20 GMT -->
<head>
		<!-- basic page needs -->	
        <meta charset="utf-8">
					...
					<div class="row">
						...
						<div class="col-xs-12 col-md-9">
							<div class="mainmenu">
								<nav>
									<ul>
										<li><a href="index.html">Home</a><i class="fa fa-angle-down"></i>
											<ul>
			...
			<div class="container">
				...
				<div class="row creative-member-area">	
					...
					<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
						<div class="single-creative-member">
							<div class="member-image">
								<img src="img/about-us/member1.jpg" alt="" />
					...
					<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
						<div class="single-creative-member">
							<div class="member-image">
								<img src="img/about-us/member2.jpg" alt="" />
								<div class="member-title">
									<h2>Martin  	Jerry</h2>
									<h3>Co Founder</h3>									
								</div>
					...
					<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
						<div class="single-creative-member">
							<div class="member-image">
								<img src="img/about-us/member3.jpg" alt="" />
								<div class="member-title">
									<h2>Danny Louis</h2>
					...
					<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
						<div class="single-creative-member">
							<div class="member-image">
								<img src="img/about-us/member4.jpg" alt="" />
								<div class="member-title">
						...
						<div class="what-client-say">
							<div class="single-item-testi">
								<div class="client-image">
									<img src="img/about-us/testi1.jpg" alt="" />
								</div>
							...
							<div class="single-item-testi">
								<div class="client-image">
									<img src="img/about-us/testi2.jpg" alt="" />
								</div>
								<div class="client-text">
									<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis,…</p>
									<h2>TERESA</h2>
							...
							<div class="single-item-testi">
								<div class="client-image">
									<img src="img/about-us/testi3.jpg" alt="" />
								</div>
								<div class="client-text">
									<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis,…</p>
									<h2>MONICA</h2>
							...
							<div class="single-item-testi">
								<div class="client-image">
									<img src="img/about-us/testi4.jpg" alt="" />
								</div>
								<div class="client-text">
									<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis,…</p>
									<h2>KATRINA</h2>
...
<!-- Mirrored from devitems.com/tf/greentech-preview/GreenTech/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 27 Dec 2015 17:15:36 GMT -->
</html>